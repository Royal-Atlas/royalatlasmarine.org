...
export default function FlagStateServicesPage() {
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 text-white py-16 lg:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">Flag State Services</h1>
            <p className="text-xl text-blue-100 mb-8">
              Comprehensive flag state services for vessel registration and regulatory compliance worldwide
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">Why Choose Our Flag State Services?</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="text-center border-2 border-blue-100">
              ...
              <CardContent>
                <CardDescription>
                  Worldwide flag state services with local expertise and regulatory compliance.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center border-2 border-blue-100">
              ...
              <CardContent>
                <CardDescription>
                  Experienced professionals with deep knowledge of flag state operations and regulations.
                </CardDescription>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">Our Flag State Services</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Comprehensive flag state solutions for all types of vessels and operational requirements
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="hover:shadow-lg transition-shadow border-2 border-blue-100">
              ...
              <CardContent>
                <CardDescription className="mb-4">
                  Professional consulting services for complex flag state and compliance issues.
                </CardDescription>
                <ul className="text-sm text-gray-600 space-y-2">
                  <li className="flex items-center">
                    <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
      ...
      <section className="py-16 bg-gradient-to-r from-slate-900 to-blue-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto text-blue-100">
            Trust our experienced team to handle your flag state requirements with professionalism and compliance.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
